...
import { c as createComponent, a as createAstro, r as renderTemplate, m as maybeRenderHead, b as addAttribute, e as renderComponent } from '../chunks/astro/server_DHF89q1R.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                 */
...
const astroLogo = new Proxy({"src":"/_astro/astro.Dm8K3lV8.svg","width":115,"height":48,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/root/code/mois/src/assets/astro.svg";
							}
...
const background = new Proxy({"src":"/_astro/background.BPKAcmfN.svg","width":1440,"height":1024,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/root/code/mois/src/assets/background.svg";
							}
...
}, "/root/code/mois/src/components/Welcome.astro", undefined);
...
}, "/root/code/mois/src/pages/index.astro", undefined);

const $$file = "/root/code/mois/src/pages/index.astro";
const $$url = "";
